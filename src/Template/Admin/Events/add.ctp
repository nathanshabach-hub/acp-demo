            ...
            <?php echo $this->Form->create($events, ['id'=>'adminForm', 'type' => 'file']); ?>
                <div class="form-horizontal">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <?php echo $this->Form->control('Events.event_id_number', ['label'=>false, 'type'=>'text',  'div'=>false, 'class'=>'form-control required', 'placeholder'=>'Event Number', 'autocomplete'=>'off']); ?>
                      </div>
                    </div>
