...
<?php if (!$evaluationquestions->isEmpty()) { ?> 
    <div class="panel-body">
        ...
        <?php echo $this->Form->create('Evaluationquestions', ['id'=>'actionFrom', "method" => "Post"]);  ?>
        ...
        if (isset($keyword) && $keyword != '') {
            echo $this->Form->control('Evaluationquestions.keyword', ['label'=>false, 'type'=>'hidden', 'value'=>$keyword]);
        }?>
