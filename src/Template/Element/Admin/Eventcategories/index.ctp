...
<?php if (!$eventcategories->isEmpty()) { ?> 
    <div class="panel-body">
        ...
        <?php echo $this->Form->create('Eventcategories', ['id'=>'actionFrom', "method" => "Post"]);  ?>
        ...
        if (isset($keyword) && $keyword != '') {
            echo $this->Form->control('Eventcategories.keyword', ['label'=>false, 'type'=>'hidden', 'value'=>$keyword]);
        }?>
